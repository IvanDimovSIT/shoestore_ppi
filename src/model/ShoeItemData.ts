...
export class ShoeItemData{
    ...
    public static init():void{
        ...
        this.shoes.set(2, new ShoeItem(2,"Air Max 1 '87",299.99, "../assets/shoes/shoe2.png", Genders.M, Colors.Red ,["36", "38", "40" , "42", "43", "44", "45", "45.5", "46", "47", "47.5", "48", "49"],"Modernise a classic with this edition of the Air Max 1. The iconic safari print you know from past grails is grounded in calming neutrals, delivering a dose of easy-to-style wild. Embroidered accents on the sides showcase your animal instinct, while premium leather and airy mesh root your look to the original design. Add in some tried-and-tested Nike Air cushioning and that classic wavy mudguard—no wonder it's reigned supreme since 1987.","Nike"));
